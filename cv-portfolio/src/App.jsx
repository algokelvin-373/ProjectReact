      ...
      <div ref={cvRef} className="w-full">
        ...
        <header className="bg-white/80 backdrop-blur-md shadow-lg sticky top-0 z-50 border-b border-indigo-100">
          <div className="max-w-6xl mx-auto px-4 py-5 flex justify-between items-center">
            ...
            <button
              onClick={() => downloadCV()}
              className="flex items-center space-x-2 bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-6 py-3 rounded-full hover:shadow-lg hover:scale-105 transition-all duration-300 font-medium"
            >
              <Download size={18} />
        ...
        <main className="max-w-6xl mx-auto px-4 py-12">
          ...
          <section className="mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              <div className="bg-white p-4 rounded-xl shadow-md hover:shadow-lg transition-all duration-300 border border-gray-100 hover:border-indigo-200">
              ...
              <div className="bg-white p-4 rounded-xl shadow-md hover:shadow-lg transition-all duration-300 border border-gray-100 hover:border-green-200">
              ...
              <div className="bg-white p-4 rounded-xl shadow-md hover:shadow-lg transition-all duration-300 border border-gray-100 hover:border-gray-800">
                ...
                <p className="text-xs text-gray-600 font-medium mb-1">GitHub</p>
                <p className="text-sm font-semibold text-gray-800 truncate">
                  {personalInfo.github}
                </p>
              </div>
          ...
          <section className="bg-white rounded-2xl shadow-md p-8 mb-12 border border-gray-100">
          ...
          <section className="mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {projects.map((project, index) => (
                <div
                  key={index}
                  className="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 border border-gray-100 hover:border-indigo-200 group"
                >
